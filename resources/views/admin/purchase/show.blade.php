                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 text-center">
                                <label for="nombre" class="form-control-label">Número de compra</label>
                                <p>{{ $purchase->id }}</p>
                            </div>
                        </div>
                        <br /><br />
                                ...
                                <table id="detalles" class="table">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <p align="right">{{number_format($subtotal * $purchase->tax*18/100,2)}}</p>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th colspan="3">
                    ...
                    <div class="card-footer text-muted">
                        <a href="{{ route('purchases.index') }}" type="button"
