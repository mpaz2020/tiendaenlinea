                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-4">
                                <div class="myaccount-tab-menu nav" role="tablist">
                                    ...
                                    <a href="{{route('web.account_info')}}" {!! active_class(route('web.account_info'))!!}"><i class="fa fa-user"></i> Detalles de la cuenta</a>
                                    <a href="login-register.html"><i class="fa fa-sign-out"></i> Salir</a>
                                </div>
                            </div>
